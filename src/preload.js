...
contextBridge.exposeInMainWorld('electronAPI', {
    ...
    selectExtractOutputFile: (extension) => ipcRenderer.invoke('select-extract-output-file', extension),
    ...
    // 书签提取相关
    extractBookmarks: (options) => ipcRenderer.invoke('extract-bookmarks', options),
